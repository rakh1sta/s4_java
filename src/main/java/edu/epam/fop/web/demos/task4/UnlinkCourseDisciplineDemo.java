...
public class UnlinkCourseDisciplineDemo {

    public static void main(String[] args) {
        // TODO write your code here
        if (args.length != 2) {
            System.out.println("Usage: UnlinkCourseDisciplineDemo <course_id> <discipline_id>");
            return;
        }
        ...
        repository.unlinkCourseDiscipline(courseId, disciplineId);
        System.out.println("Course and discipline unlinked");
    }
}
